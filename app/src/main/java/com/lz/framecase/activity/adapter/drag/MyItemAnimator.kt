...
class MyItemAnimator : SimpleItemAnimator() {
    ...
    internal var mAdditionsList = ArrayList<ArrayList<ViewHolder>>()
    internal var mMovesList = ArrayList<ArrayList<MoveInfo>>()
    internal var mChangesList = ArrayList<ArrayList<ChangeInfo>>()

    internal var mAddAnimations = ArrayList<ViewHolder>()
    internal var mMoveAnimations = ArrayList<ViewHolder>()
    internal var mRemoveAnimations = ArrayList<ViewHolder>()
    internal var mChangeAnimations = ArrayList<ViewHolder>()

    class MoveInfo internal constructor(var holder: ViewHolder, var fromX: Int, var fromY: Int, var toX: Int, var toY: Int)
    ...
    class ChangeInfo private constructor(var oldHolder: ViewHolder?, var newHolder: ViewHolder?) {
        ...
        internal constructor(oldHolder: ViewHolder, newHolder: ViewHolder,
    ...
    internal fun animateAddImpl(holder: ViewHolder) {
        val view = holder.itemView
        val animation = view.animate()
    ...
    override fun animateMove(holder: ViewHolder, fromX: Int, fromY: Int,
        ...
        mPendingMoves.add(MyItemAnimator.MoveInfo(holder, fromX, fromY, toX, toY))
        return true
    }

    internal fun animateMoveImpl(holder: ViewHolder, fromX: Int, fromY: Int, toX: Int, toY: Int) {
        val view = holder.itemView
        val deltaX = toX - fromX
        val deltaY = toY - fromY
        if (deltaX != 0) {
    ...
    override fun animateChange(oldHolder: ViewHolder, newHolder: ViewHolder?,
        ...
        mPendingChanges.add(MyItemAnimator.ChangeInfo(oldHolder, newHolder!!, fromX, fromY, toX, toY))
        return true
    }

    internal fun animateChangeImpl(changeInfo: MyItemAnimator.ChangeInfo) {
    ...
    private fun endChangeAnimationIfNecessary(changeInfo: MyItemAnimator.ChangeInfo) {
    ...
    private fun endChangeAnimationIfNecessary(changeInfo: MyItemAnimator.ChangeInfo, item: ViewHolder?): Boolean {
        var oldItem = false
     ...
     *
     *
     * If the payload list is not empty, MyItemAnimator returns `true`.
     ...
     * then MyItemAnimator will call [.animateMove] and
