 ...
 */
class ItemTouchListCallBack(
        private val mAdapter: BaseItemDraggableAdapter<*, *>) : ItemTouchHelper.Callback() {
    ...
    private fun isViewCreateByAdapter(viewHolder: RecyclerView.ViewHolder): Boolean {
        ...
        return if (type != TitleBean.MYTITLESub)
            true
        else
            type == BaseQuickAdapter.HEADER_VIEW || type == BaseQuickAdapter.LOADING_VIEW
